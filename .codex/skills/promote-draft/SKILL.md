...
4) Remove common AI writing tells (see `notes/ai-writing-tells.md`): puffery, promo tone, weasel wording, filler wrap-ups, assistant-chat phrasing, placeholders.
5) Add at least one scar if relevant to the topic.
6) Refresh Assets needed, Open questions / assumptions, and Fact check list.
...
- Avoid common AI writing tells from `notes/ai-writing-tells.md`.
